        ...
        ws.on('message', data => {
            ...
            switch (message[0]) {
                ...
                case incoming.servo_reset:
                    if (!remoteControll.isController(ws)) break;
                    receiveMessages(`Lenkung wird zentriert.`, importance.MEDIUM);
                    hardware.sendData(null, `${incoming.servo_reset}`);
                    break;

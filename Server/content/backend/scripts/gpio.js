...
function updateBattery(interval) {
    setInterval(() => {
        fs.readFile(`${global.path}/content/backend/data/battery.txt`, 'utf8', (error, data) => {
            if (error) {
...
function updateCamera(interval) {
    setInterval(() => {
        fs.readFile(`${global.path}/content/backend/data/camera.txt`, 'utf8', (error, data) => {
            if (error) {
...
function updateCoords(interval) {
    setInterval(() => {
        fs.readFile(`${global.path}/content/backend/data/coords.txt`, 'utf8', (error, data) => {
            if (error) {
...
function updateSpeed(interval) {
    setInterval(() => {
        fs.readFile(`${global.path}/content/backend/data/speed.txt`, 'utf8', (error, data) => {
            if (error) {
